...
const constantRouterComponents = {
  ...
  // views
  Index: () => import('@/views/home/Index'),
  DashboardIndex: () => import('@/views/dashboard/Index'),
  Release: () => import('@/views/dashboard/Release'),
  Tagging: () => import('@/views/dashboard/Tagging'),
  Check: () => import('@/views/dashboard/Check'),
  Storage: () => import('@/views/dashboard/Storage'),
  Visualization: () => import('@/views/kg/Visualization'),
  Search: () => import('@/views/kg/Search'),
}
