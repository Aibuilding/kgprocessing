...
import kg from '@/router/modules/kg'
...
let syncRouterMap = [
  {
    ...
    redirect: `${defaultRootRoutePath}/index`,
    meta: { title: '首页' },
    children: [
      // 默认页
      {
        ...
        meta: { title: '首页', keepAlive: true, icon: 'dashboard', permission: ['home'] },
        children: [
          {
            path: `${defaultRootRoutePath}/index`,
            name: 'index',
