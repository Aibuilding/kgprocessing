  ...
  const admin_nav = [
    {
      ...
      meta: { title: '主页', keepAlive: true, icon: 'dashboard', permission: ['dashboard'] },
    },
    {
      parentId: 11,
      id: 111,
    ...
    },
    {
      ...
      name: 'release',
      component: 'Release',
      meta: { title: '发布任务', keepAlive: true, permission: ['dashboard'] },
    },
    {
      parentId: 12,
      id: 123,
      path: '/dashboard/tagging',
      name: 'tagging',
      component: 'Tagging',
      meta: { title: '人工标注', keepAlive: true, permission: ['dashboard'] },
    },
    {
      parentId: 12,
      id: 124,
      ...
      name: 'check',
      component: 'Check',
      meta: { title: '实体检查', keepAlive: true, permission: ['dashboard'] },
    },
    {
      parentId: 12,
      id: 125,
      ...
      name: 'storage',
      component: 'Storage',
      meta: { title: '知识入库', keepAlive: true, permission: ['dashboard'] },
    },
    {
      parentId: 0,
      id: 13,
      path: '/kg',
      name: 'kg',
      redirect: '/kg/visualization',
      component: 'RouteLayout',
      meta: { title: '知识图谱', keepAlive: true, icon: 'dashboard', permission: ['dashboard'] },
    },
    {
      parentId: 13,
      id: 131,
      path: '/kg/visualization',
      name: 'visualization',
      component: 'Visualization',
      meta: { title: '图谱可视化', keepAlive: true, permission: ['dashboard'] },
    },
    {
      parentId: 13,
      id: 132,
